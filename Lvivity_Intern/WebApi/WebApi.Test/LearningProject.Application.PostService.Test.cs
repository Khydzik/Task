...
namespace WebApi.Test
{
    ...
    public class LearningProjectApplicationPostServiceTest
    {
        ...
        public async Task CreateNewPostCheckIsNullNewPost_Test()
        {
            ...
            Exception ex = await Assert.ThrowsAsync<NullReferenceException>(() => postService.IsCreateNewPost(newPostModel));
        ...
        public async Task CreateNewPostCheckIsNullFile_Test()
        {
            ...
            Exception ex = await Assert.ThrowsAsync<NullReferenceException>(() => postService.IsCreateNewPost(createPostModel));
        ...
        public void CreateNewPostCheckReturnTrue_Test()
        {
            ...
            var result = postService.IsCreateNewPost(createPostModel);
        ...
        public async Task CreateNewPostCheckIsTypeOfFile_Test()
        {
            ...
            Exception ex = await Assert.ThrowsAsync<Exception>(() => postService.IsCreateNewPost(createPostModel));
