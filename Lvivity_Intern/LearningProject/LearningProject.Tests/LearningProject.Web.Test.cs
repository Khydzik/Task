...
namespace LearningProject.Tests
{
    ...
    public class LearningProjectWebTest
    {
        ...
        public void EditCheckReturnTrue_Test()
        {
            ...
            mock.Setup(repo => repo.ChangeUserRole(editModel)).Returns(async() => { return user.Role.Name; });
        ...
        public void CreatePostCheckReturnTrue_Test()
        {
            ...
            mock.Setup(repo => repo.CreatePost(createPostModel)).Returns(async() => { return true; });
